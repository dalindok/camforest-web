                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                    <div className="text-left">
                        ...
                        <p className="text-2xl mt-4 max-w-md">
                            To connect people with the world of trees by providing detailed information on various species. 
                            We offer insights into the benefits of each tree, such as their ecological roles and uses, 
                    ...
                    <div className="grid grid-cols-2 gap-2 pr-4">
                        ...
                        <img src={tectorius} alt="Tree 3" className="col-span-2 rounded-lg shadow-lg"/>
                    </div>
                </div>
            </div>
        </div>
